...
public class PokemonSteps {
    ...
    public void deberiaVerElCuerpoDelJSONExitosamente() {
       ...
       theActorInTheSpotlight().should(seeThat("El nombre del pokemon es correcto", act -> new ObtenerPokemones().answeredBy(theActorInTheSpotlight()), equalTo("https://pokeapi.co/api/v2/language/1/")));
    }
}
